...
export type Config = {
  ...
  streamFirstTimeout: number; // Timeout for receiving the first token in streaming mode (ms)
  streamTokenTimeout: number; // Timeout for receiving subsequent tokens in streaming mode (ms)
};
